...
const languagePacks = {
  ...
  'zh-cn': {
     ...
     'orders.col.earnings': '已领收益',
     'orders.col.pending': '未领收益',
  ...
  'zh-tw': {
     ...
     'orders.col.earnings': '已領收益',
     'orders.col.pending': '未領收益',
     ...
     'orders.progress.recovery': '回本進度',
     'orders.roi.recovered': '已回本',
     'orders.roi.guarantee': '保底線',
     'orders.btn.harvest': '領取收益',
     'orders.btn.unstake': '提前撤資',
     'orders.empty': '暫無訂單記錄',
     'orders.loading': '加載中...',
  ...
  'ja': {
     ...
     'orders.col.earnings': '受取済み',
     'orders.col.pending': '未受取収益',
  ...
  'ko': {
     ...
     'orders.col.earnings': '수령액',
     'orders.col.pending': '미수령 수익',
