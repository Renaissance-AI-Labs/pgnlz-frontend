...
const languagePacks = {
  'en': {
    ...
    'home.announcement.b2': 'DAPP Domain Upgrade: To align with the brand and functional upgrade, the DAPP domain will be officially updated tomorrow, providing you with a more convenient and secure access point.',
  ...
  'zh-cn': {
     ...
     'home.announcement.b2': 'DAPP 域名升级：为配合品牌与功能升级，DAPP 域名将于明日正式更新，为您提供更便捷、更安全的访问入口。',
  ...
  'zh-tw': {
     ...
     'home.announcement.b2': 'DAPP 域名升級：為配合品牌與功能升級，DAPP 域名將於明日正式更新，為您提供更便捷、更安全的訪問入口。',
  ...
  'ja': {
     ...
     'home.announcement.b2': 'DAPPドメインのアップグレード：ブランドと機能のアップグレードに合わせて、DAPPドメインは明日正式に更新され、より便利で安全なアクセス入口を提供します。',
  ...
  'ko': {
     ...
     'home.announcement.b2': 'DAPP 도메인 업그레이드: 브랜드 및 기능 업그레이드에 맞춰 DAPP 도메인이 내일 공식적으로 업데이트되어 더 편리하고 안전한 접속 경로를 제공할 것입니다.',
